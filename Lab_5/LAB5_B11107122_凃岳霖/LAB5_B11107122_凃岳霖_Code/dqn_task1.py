...
# python dqn.py --env ALE/Pong-v5 --wandb-run-name task2 \
#   --memory-size 100000 --replay-start-size 50000 \
#   --epsilon-decay 0.9999995 --episodes 5000
#
# Task 3 — Enhanced DQN (DDQN + PER + Multi-step n=3)
# python dqn.py --env ALE/Pong-v5 --wandb-run-name task3 \
#   --use-double --use-per --n-step 3 \
#   --memory-size 100000 --replay-start-size 50000 \
#   --epsilon-decay 0.9999995 --episodes 5000
